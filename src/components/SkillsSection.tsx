...
export const SkillsSection = ({
  skills,
}: { skills: { title: string; tags?: { name: string }[] }[] }) => {
        ...
        {skills.map((category, idx) => (
          ...
          >
            <div className="skill-category-card" style={{ width: "100%" }}>
                  ...
                  >
                    <img
                      src={
                        ...
                        "https://api.iconify.design/mdi:rocket-launch-outline.svg?color=%2322d3ee"
                      }
                      alt=""
              ...
              >
                {category.tags?.map((tag: { name: string }, tIdx: number) => (
                  <SkillChip key={tag.name} name={tag.name} />
                ))}
              </div>
            </div>
          </RevealFx>
